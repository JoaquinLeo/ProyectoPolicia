<!-- 104) Cabecera de los administradores -->
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item" >
                        <a class="nav-link" href="index.php">Control presentismo</a>
                    </li>
                    <li class="nav-item" >
                        <a class="nav-link" href="historial.php">Historial presentismo</a>
                    </li>
                    <li class="nav-item" >
                        <a class="nav-link" href="ingresantes.php">Ingresantes</a>
                    </li>
                    <li class="nav-item" >

    ...
    <div>
        <main class="form-signin w-100 m-auto">
            <form action="validar.php" method="POST">
                ...
                <button class="btn btn-primary btn-lg" type="button" value="Registrar" onclick='registrar()'>Registrar</button>
                <button class="btn btn-primary btn-lg" type="submit" value="Ingresar" name="ingresar">Ingresar</button>
            </form>
        </main>
        <script>
            function registrar(){

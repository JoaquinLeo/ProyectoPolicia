...
<body class="text-center">
    <main class="form-signin w-100 m-auto">
        <form action="fin_registro.php" method="post">
            ...
            <button class="btn btn-primary boton" type="Sumbit" value="Enviar">Enviar</button>
            <button class="btn btn-primary boton" type="button" value="Volver" onclick='volver()'>Volver</button>
        </form>
    </main>
    <script>
        function volver(){
